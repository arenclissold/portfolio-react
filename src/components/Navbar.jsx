...
export default function Navbar() {
	...
	return (
		<nav
			className={`w-full flex justify-between items-center fixed z-[1001] shadow-lg backdrop-blur p-2
    ...
    ${show && "pb-36"}`}
		>
			...
			<div
				className={`text-lg absolute top-[-10rem] flex items-center flex-col w-full
