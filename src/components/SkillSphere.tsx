...
const defaultState: tagSphereProps = {
	texts: [
		...
		<img src="/nextjs.png" alt="Next.js" width={70} />,
		...
		<img
			...
			width={40}
		/>,
		<img src="https://cdn.svgporn.com/logos/aws.svg" alt="AWS" width={60} />,
		<img
		...
		<img
			...
			width={40}
		/>,
		<img src="/styled-components.png" alt="StyledComponents" width={100} />,
		<img
