...
export default function Projects() {
	const projectData = [
		{
			name: "Tic Tac Toe",
			description:
				"A game of Tic Tac Toe made using React, Tailwind and Vite. Featuring time travel and a beautiful UI.",
			img: ticTacToe,
	...
	const Project = (props) => {
		const Technology = (props) => {
			return (
				<div className=" bg-blue-300 text-blue-700 m-0.5 rounded border-blue-700 border-2 px-1">
					{props.name}
				</div>
			);
		};
		...
		return (
			<div className="h-40 border-white border-[3px] rounded-lg relative z-10 bg-white shadow-lg transition-all duration-300 transform hover:scale-105">
				<img
				...
				<div className="absolute h-full w-full z-10 top-0 bg-slate-900 bg-opacity-70 rounded-lg p-2 flex flex-col justify-center">
					...
					{props.data.github ? (
						<div className="flex justify-center">
							<a
								className="text-black bg-blue-400 bg-opacity-90 rounded-3xl mx-1 p-2"
						...
						<div className="flex justify-center text-white">Coming Soon</div>
					)}
	...
	const GithubSquare = () => {
		return (
			<div
				className="h-40 w-full p-2 z-10 top-0 bg-slate-600 bg-opacity-70 rounded-lg
			...
			>
				<h4 className="text-white text-center">
					...
					<a
						...
						href="https://github.com/arenclissold/"
					>
						github profile
					</a>{" "}
