...
export default function Experience() {
    ...
    return (
      <div className="h-80 shadow-lg md:shadow-none mt-28 relative">
        ...
        ${props.index % 2 === 1 ? '' : 'float-right  md:items-end'}`
          ...
          <p className=" md:bg-[#001f54] md:p-6 rounded md:shadow-lg" dangerouslySetInnerHTML={{__html: props.data.description}}>
            {}
          </p>
          <p>
  ...
  const projects = projectData.map((data, i) => <ExperienceCard key={i} data={data} index={i} />)
