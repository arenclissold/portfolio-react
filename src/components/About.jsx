    ...
    <section id="about">
      ...
      <div className="grid grid-cols-12 mt-10">
        <div className="col-span-12 lg:col-span-5">
          <p className="text-lg">
            I'm a Full Stack Software Developer who loves problem-solving, learning new skills and working with passionate people.
            <br /><br />
            ...
            <br /><br />
            In my time away from the screen, I enjoy bouldering 🧗‍♂️, hiking ⛰️, camping ⛺️ and running 🏃‍♂️. I also love travelling ✈️ and learning Japanese 🇯🇵.
          </p>
        </div>
